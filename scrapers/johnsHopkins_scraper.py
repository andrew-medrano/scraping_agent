...
class ScraperConfig:
    ...
    university: str = "johnsHopkins"  # FILL THIS OUT: This is the name of the university
    ...
    selectors = {
        'item_links': ".hit-content-left > .hit-name",
        'next_button': ".ais-Pagination-item--nextPage"
    }
    jina_remove_selectors = '.c_top_logo_link_bar > tbody > tr > td'
    jina_target_selectors = '.c_content_item'
