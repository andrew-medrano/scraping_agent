...
class ScraperConfig:
    start_urls: List[str] = field(default_factory=lambda: [
        "https://techtransfer.universityofcalifornia.edu/Default?campus=DA&RunSearch=True&ShowDetail=False&SortASC=False&SortColumn=NCDId"
    ])
    university: str = "ucDavis"  # FILL THIS OUT: This is the name of the university
