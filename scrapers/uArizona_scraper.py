...
class ScraperConfig:
    start_urls: List[str] = field(default_factory=lambda: [
        "https://inventions.arizona.edu/?"
    ])
    university: str = "uArizona"  # FILL THIS OUT: This is the name of the university
    ...
    selectors = {
        'item_links': ".ais-Hits-item .hit-name",
        'next_button': "#pagination2 .ais-Pagination-item--nextPage > .ais-Pagination-link"
    }
    jina_remove_selectors = '#header #top_nav_logo #top_nav #sidenav'
    jina_target_selectors = '.c_content'
