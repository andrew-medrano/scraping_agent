...
class ScraperConfig:
    start_urls: List[str] = field(default_factory=lambda: [
        "https://techtransfer.universityofcalifornia.edu/Default?campus=sb&RunSearch=True&ShowDetail=False&SortASC=False&SortColumn=NCDId"
    ])
    university: str = "ucSantaBarbara"  # FILL THIS OUT: This is the name of the university
