...
class ScraperConfig:
    start_urls: List[str] = field(default_factory=lambda: [
        "https://uchicago.technologypublisher.com/site/search?technologies%5Bpage%5D"
    ])
    university: str = "uChicago"  # FILL THIS OUT: This is the name of the university
    ...
    selectors = {
        'item_links': ".a-technology a.a-technology__link",
        'next_button': ".ais-Pagination-item--nextPage > .ais-Pagination-link"
    }
    jina_remove_selectors = '.page-sidebar, .h, .f'
    jina_target_selectors = '.page-inner'
